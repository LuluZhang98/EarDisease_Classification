...
class CustomMobileNetV2(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.model = mobilenet_v2(pretrained=True)  # Load pre-trained weights

        # Adjust the last fully connected layer to match the desired number of classes
...
def mobilenet_predict(img_path):
    ...
    transform = transforms.Compose([
        transforms.Resize((244, 244)),  # Resize to the desired input size of the model
        transforms.ToTensor(),
    ])
